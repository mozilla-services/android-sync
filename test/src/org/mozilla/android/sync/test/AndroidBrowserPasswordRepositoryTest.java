...
import org.mozilla.gecko.sync.repositories.android.AndroidBrowserPasswordsRepositorySession;
  ...
  protected AndroidBrowserRepository getRepository() {
    ...
    return new AndroidBrowserPasswordsRepository() {
      ...
      protected void sessionCreator(RepositorySessionCreationDelegate delegate, Context context) {
        AndroidBrowserPasswordsRepositorySession session;
        session = new AndroidBrowserPasswordsRepositorySession(this, context) {
          @Override

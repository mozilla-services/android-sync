...
BROWSERCONTRACT=src/main/java/org/mozilla/gecko/sync/repositories/android/BrowserContract.java
...
$PREPROCESSOR $DEFINITIONS $BROWSERCONTRACT.in | sed -e '/#filter substitution/d' -e 's/package org.mozilla.gecko.db;/package org.mozilla.gecko.sync.repositories.android;/' > $BROWSERCONTRACT

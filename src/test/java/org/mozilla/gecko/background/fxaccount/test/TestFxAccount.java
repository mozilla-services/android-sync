...
import org.mozilla.gecko.background.fxaccount.FxAccount;
import org.mozilla.gecko.background.fxaccount.SRPSession;
...
public class TestFxAccount {
  ...
  public void testMakeFxAccount() throws Exception {
    FxAccount account = FxAccount.makeFxAccount(TEST_EMAIL, TEST_PASSWORD, TEST_MAINSALT, TEST_SRPSALT);
  ...
  public void testMakeFxAccountUnicode() throws Exception {
    FxAccount account = FxAccount.makeFxAccount(TEST_EMAIL_UNICODE, TEST_PASSWORD_UNICODE, TEST_MAINSALT, TEST_SRPSALT);
    Assert.assertEquals(TEST_MAINSALT, account.mainSalt);
    Assert.assertEquals(TEST_SRPSALT, account.srpSalt);

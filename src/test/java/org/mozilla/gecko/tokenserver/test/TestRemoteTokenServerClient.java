...
public class TestRemoteTokenServerClient {
  ...
  public void testRemoteSuccess() throws Exception {
    String assertion = JWCrypto.createMockMyIdAssertion(TEST_USERNAME, TEST_REMOTE_AUDIENCE);
  ...
  public void testRemoteFailure() throws Exception {
    String badAssertion = JWCrypto.createMockMyIdAssertion(TEST_USERNAME, TEST_REMOTE_AUDIENCE, 0, 1);

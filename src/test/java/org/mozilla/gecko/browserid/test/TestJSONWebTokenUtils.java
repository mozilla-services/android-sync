...
public class TestJSONWebTokenUtils {
  public void doTestEncodeDecode(KeyPair keyPair) throws Exception {
  ...
  public void testRSAGeneration() throws Exception {
    ...
    PublicKey mockMyIdPublicKey = RSACryptoImplementation.createPublicKey(MOCKMYID_MODULUS, MOCKMYID_PUBLIC_EXPONENT);;
    PrivateKey mockMyIdPrivateKey = RSACryptoImplementation.createPrivateKey(MOCKMYID_MODULUS, MOCKMYID_PRIVATE_EXPONENT);
    PublicKey publicKeyToSign = RSACryptoImplementation.createPublicKey(n, e);
    PrivateKey privateKeyToSignWith = RSACryptoImplementation.createPrivateKey(n, d);
  ...
  public void testDSAGeneration() throws Exception {
    ...
    PublicKey mockMyIdPublicKey = DSACryptoImplementation.createPublicKey(MOCKMYID_y, MOCKMYID_p, MOCKMYID_q, MOCKMYID_g);
    PrivateKey mockMyIdPrivateKey = DSACryptoImplementation.createPrivateKey(MOCKMYID_x, MOCKMYID_p, MOCKMYID_q, MOCKMYID_g);
    PublicKey publicKeyToSign = DSACryptoImplementation.createPublicKey(y, p, q, g);
    PrivateKey privateKeyToSignWith = DSACryptoImplementation.createPrivateKey(x, p, q, g);

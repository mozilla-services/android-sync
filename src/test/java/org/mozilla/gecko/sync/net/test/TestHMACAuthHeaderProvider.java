...
public class TestHMACAuthHeaderProvider {
  ...
  public void testGetRequestStringSpecExample1() throws Exception {
    ...
    assertEquals(expected, HMACAuthHeaderProvider.getRequestString(req, timestamp, nonceString, extra));
  }
  ...
  public void testSpecSignatureExample() throws Exception {
    // String identifier = "h480djs93hd8";
    // String keyString = "489dks293j39";
    ...
    String requestString = HMACAuthHeaderProvider.getRequestString(req, timestampInSeconds, nonceString, extra);
  ...
  public void testCompatibleWithDesktopFirefox() throws Exception {
    ...
    assertEquals("jzh5chjQc2zFEvLbyHnPdX11Yck=", HMACAuthHeaderProvider.getSignature(requestString, keyString));
  }
}

...
public class ProviderWebView extends WebView {

  public interface ProviderWebViewHandler {

  }

  public static final String TAG = "ProviderWebView";
  ...
  public ProviderWebView(Context context) {
    ...
    String databasePath = context.getDir("database", Context.MODE_PRIVATE)
        .getPath();
  ...
  public void beginBrowsing(String url, boolean visible) {
    clearHistory();
    clearView();
  ...
  private void endProvisioning(String certificate, String error) {
    ...
    if (error != null) {
      ...
      // Toast.makeText(this, "Provisioned!", Toast.LENGTH_SHORT);
      // finish();
      // TODO: Return result
    }
  }

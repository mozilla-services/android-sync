...
public class MetaGlobalException extends SyncException {
  ...
  public static class MetaGlobalMissingEnginesException extends MetaGlobalException {
    private static final long serialVersionUID = 1L;
  }

  public static class MetaGlobalMalformedEnginesException extends MetaGlobalException {
    private static final long serialVersionUID = 1L;
  }
  ...
  public static class MetaGlobalStaleClientVersionException extends MetaGlobalException {
    ...
    public MetaGlobalStaleClientVersionException(final int serverVersion) {
  ...
  public static class MetaGlobalStaleClientSyncIDException extends MetaGlobalException {
    ...
    public MetaGlobalStaleClientSyncIDException(final String serverSyncID) {

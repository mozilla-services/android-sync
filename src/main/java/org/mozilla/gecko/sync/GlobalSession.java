...
public class GlobalSession implements PrefsSource, HttpResponseObserver {
   ...
   * latter, see {@link GlobalSession#isEngineLocallyDisabled(String)}.
   *
  ...
  /**
   * Return true if the named stage should <b>not</b> be synced this session.
   * <p>
   ...
   * @param stageName
   *          to query.
   * @return true if named stage is disabled for this sync.
   */
  public boolean isEngineLocallyDisabled(String stageName) {
    if (config.stagesToSync == null) {
      return false;
    }

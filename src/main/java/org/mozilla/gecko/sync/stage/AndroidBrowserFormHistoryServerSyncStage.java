...
import org.mozilla.gecko.sync.repositories.android.AndroidBrowserFormHistoryRepository;
import org.mozilla.gecko.sync.repositories.domain.FormHistoryRecord;
import org.mozilla.gecko.sync.repositories.domain.Record;

public class AndroidBrowserFormHistoryServerSyncStage extends ServerSyncStage {
  ...
  private static final long   FORM_HISTORY_REQUEST_LIMIT = 500;         // Sanity limit.
  ...
  protected Repository getLocalRepository() {
    return new AndroidBrowserFormHistoryRepository();
  }

...
public class JSONWebTokenUtils {
  ...
  public static String encode(String payload, PrivateKey privateKey) throws UnsupportedEncodingException, GeneralSecurityException  {
    return encode(payload, privateKey, null);
  }

  protected static String encode(String payload, PrivateKey privateKey, Map<String, Object> headerFields) throws UnsupportedEncodingException, GeneralSecurityException  {
    ...
    segments.add(Base64.encodeBase64URLSafeString(privateKey.signMessage(message)));
    return Utils.toDelimitedString(".", segments);
  }

  public static String decode(String token, PublicKey publicKey) throws GeneralSecurityException, UnsupportedEncodingException  {
    if (token == null) {
  ...
  protected static String getCertificatePayloadString(PublicKey publicKeyToSign, String email) throws NonObjectJSONException, IOException, ParseException  {
  ...
  public static String createCertificate(PublicKey publicKeyToSign, String email,
      String issuer, long issuedAt, long expiresAt, PrivateKey privateKey) throws NonObjectJSONException, IOException, ParseException, GeneralSecurityException  {
  ...
  public static String createCertificate(PublicKey publicKeyToSign, String email, PrivateKey privateKey) throws NonObjectJSONException, IOException, ParseException, GeneralSecurityException  {
  ...
  public static String createAssertion(PrivateKey privateKeyToSignWith, String certificate, String audience,
  ...
  public static String createAssertion(PrivateKey privateKeyToSignWith, String certificate, String audience) throws NonObjectJSONException, IOException, ParseException, GeneralSecurityException  {

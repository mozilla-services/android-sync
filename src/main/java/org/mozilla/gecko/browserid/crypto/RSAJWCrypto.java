...
public class RSAJWCrypto {
  ...
  public static String assertion(
      ...
      final String audience,
      final long issuedAt,
      final long durationInMilliseconds) throws Exception {

    final long expiresAt = issuedAt + durationInMilliseconds;

    String assertion = signature(new ExtendedJSONObject(), issuer, issuedAt, audience, expiresAt, privateKeyToSignWith);
  ...
  public static String assertion(
    ...
    final long durationInMilliseconds = 60 * 60 * 1000;

    return assertion(privateKeyToSignWith, certificate, issuer, audience, issuedAt, durationInMilliseconds);
  }
}

...
public class MockMyIDTokenFactory {
  ...
  protected static PrivateKey cachedMockMyIDPrivateKey = null;
   ...
   * @throws Exception
   */
  public String createMockMyIDCertificate(final PublicKey publicKeyToSign, String username,
   ...
   * @throws Exception
   */
  public String createMockMyIDAssertion(KeyPair keyPair, String username, String audience,

 ...
 *
 */
public class PICLStorageCollectionRequest extends PICLStorageRequest {
  private static final String LOG_TAG = "CollectionRequest";

  public PICLStorageCollectionRequest(URI uri) {
    super(uri);
  }
  ...
  protected BaseResourceDelegate makeResourceDelegate(SyncStorageRequest request) {
    return new PICLCollectionResourceDelegate((PICLStorageCollectionRequest) request);
  }

  // TODO: this is awful.
  public class PICLCollectionResourceDelegate extends
    PICLStorageResourceDelegate {
    ...
    PICLCollectionResourceDelegate(PICLStorageCollectionRequest request) {
      super(request);
    }

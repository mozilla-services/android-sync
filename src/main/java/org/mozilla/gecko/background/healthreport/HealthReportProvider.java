 ...
 *
 * Query, of course:
 *    content://org.mozilla.gecko.health/events/?since
 *
 * Any operation can take an optional time argument (defaults to now), and a
 * mandatory profilePath argument and env argument.
 *

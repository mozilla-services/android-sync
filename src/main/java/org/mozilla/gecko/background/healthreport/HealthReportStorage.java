...
public interface HealthReportStorage {
  ...
  public abstract class Field {
    protected static int FLAG_INTEGER  = 0;
    protected static int FLAG_STRING   = 1;
    protected static int FLAG_DISCRETE = 4;
    protected static int FLAG_LAST     = 8;
    protected static int FLAG_COUNTER  = 16;

    public static int TYPE_INTEGER_DISCRETE = FLAG_INTEGER | FLAG_DISCRETE;
    public static int TYPE_INTEGER_LAST     = FLAG_INTEGER | FLAG_LAST;
    public static int TYPE_INTEGER_COUNTER  = FLAG_INTEGER | FLAG_COUNTER;

    public static int TYPE_STRING_DISCRETE  = FLAG_STRING | FLAG_DISCRETE;
    public static int TYPE_STRING_LAST      = FLAG_STRING | FLAG_LAST;
